      ...
      <div className="bg-white p-4 w-full rounded-2xl transition duration-700 ease-in-out  sm:shadow-md md:shadow-none hover:drop-shadow-lg">
        <div className="w-full relatice">
          <div className="w-full bottom-4 flex items-end justify-between">
            <div className="flex flex-col gap-2 item-start absolute">
              {props.isPro && (
              ...
              {props.isOff && (
                <span className="bg-blue-600 text-white px-2 py-1  mb-1 rounded text-sm">
                  $250 OFF
                </span>
              )}
            </div>
          ...
          <div className="my-2 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between text-gray-500 gap-20">
